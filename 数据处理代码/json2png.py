...
if __name__ == '__main__':
    jpgs_path   = "/Users/zhangyuchen/Desktop/Results Fig/xxformer"
    pngs_path   = "/Users/zhangyuchen/Desktop/Results Fig/xxformer"
    ...
    classes     = ["_background_","soil","rust"]
    #_background_实际上是健康的小麦块，在标注中作背景处理
    
    count = os.listdir(jpgs_path) 
    for i in range(0, len(count)):
        path = os.path.join(jpgs_path, count[i])
        ...
        if os.path.isfile(path) and path.endswith('json'):
            ...
            # label_name_to_value = {'_background_': 120}
            # label_name_to_value = {'soil': 0}
            # label_name_to_value = {'rust': 200}
